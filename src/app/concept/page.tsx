...
const ITEMS = [
  {
    ...
    hook: "카피를 하나씩 쓰던 방식, 이제 바꿀 때입니다",
    struct: "히어로 + 자동 재생 콘솔 → 가치 3 → 기능 6 → 펼치는 실행 5단계",
  ...
  },
  {
    ...
    struct: "자동 전환 확장 패널 → 카운트업 지표 → 펼치는 구매여정 6단계 → 문안 전후 스위치",
  ...
  },
  {
    ...
    struct: "타이핑 히어로 → 카운트업 지표 → 검수 원칙 아코디언 → 그려지는 타임라인 → FAQ",
  ...
  },
  {
    ...
    struct: "짧은 히어로 → 순차 등장 벤토 10칸(칩 클릭 전환) → CTA",
  ...
  },
  {
    ...
    hook: "받아보실 결과물은 이렇게 전달됩니다",
    struct: "행이 차례로 채워지는 검수 파일 → 사용 3단계(톤 반전 밴드) → 좌우 교차 상세",
  ...
  },
  {
    ...
    hook: "사람들이 질문을 던지는 자리에 브랜드를 놓습니다",
    struct: "단어 순환 히어로 + 카운트업 지표 + 벤토 그리드 + 펼치는 실행 단계",
    ...
    <div className={s.root}>
      <div className={s.wrap}>
        ...
        <div className={s.rules}>
          <b>여섯 시안 공통</b>
          <ul>
            <li><b>라이트/다크 토글</b>이 모두 들어 있습니다. 헤더 오른쪽 ☀ / ☾ 버튼으로 바꾸시면 선택이 기억됩니다.</li>
            <li><b>기존 텍스트 적용</b> 버튼을 누르면 지금 운영 중인 메인 페이지 문장으로 바뀐 같은 디자인을 보실 수 있습니다.</li>
            <li>히어로와 각 콘텐츠 영역에 <b>동적·인터랙티브 요소</b>를 넣었습니다. 눌러보고 올려보실 수 있습니다.</li>
